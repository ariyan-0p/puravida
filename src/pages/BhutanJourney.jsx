  ...
  return (
    <>
      <style>{`
        ...
        .bj-cta-wa:hover { background: #c08e88; color: #FFFFFF; }
        .bj-cta-date-bar {
        ...
        @media (max-width: 600px) {
          ...
          .bj-farewell-card { padding: 28px 24px; max-width: 280px; }
          .bj-farewell-text { font-size: 16px; }
          .bj-farewell-frame { inset: -6px -6px -10px -12px; }
        }
      `}</style>
